                        ...
                        <div className="flex justify-between items-center text-sm pt-2 border-t border-slate-200 dark:border-slate-700">
                            ...
                            <div className="flex flex-col items-end">
                                ...
                                {(() => {
                                    ...
                                    else if (val.includes('most_delivered') || val.includes('first_n_delivered')) label = t('promotions.targetTypes.most_delivered', 'Most delivered orders');
                                    else if (val.includes('least_delivered') || val.includes('last_n_delivered')) label = t('promotions.targetTypes.least_delivered', 'Least delivered orders');
