        ...
        <div className="p-6 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {navItems.filter(item => item.visible).map((item) => (
                    <button
                        ...
                        className="group flex flex-col p-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-none text-left transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10 hover:border-primary/50 relative overflow-hidden active:scale-95"
                    >
                        {/* Decorative Background Icon */}
                        <item.icon className="absolute -right-4 -bottom-4 w-32 h-32 text-slate-50 dark:text-slate-800/50 opacity-0 group-hover:opacity-100 transition-all duration-500 group-hover:scale-110" />
            ...
            <div className="mt-20 p-12 bg-slate-100 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-none flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="relative">
                    <div className="w-24 h-24 bg-primary rounded-none absolute -top-4 -left-4 animate-pulse opacity-20" />
                    <div className="w-24 h-24 bg-blue-500 rounded-none absolute -bottom-4 -right-4 animate-pulse opacity-20 delay-75" />
