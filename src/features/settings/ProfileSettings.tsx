        ...
        <div className="p-6 max-w-2xl mx-auto space-y-8 animate-in animate-fade">
            ...
            <div className="flex items-center gap-4 mb-12">
                ...
                <div>
                    <h2 className="text-4xl font-black text-slate-900 dark:text-slate-100 tracking-tight">
                        {t('personalInformation', { defaultValue: 'Account Settings' })}
                    </h2>
                    <p className="text-slate-500 font-medium">
                        {t('manageAccountDetails', { defaultValue: 'Update your personal profile and security' })}
                    </p>
                </div>
            </div>

            {/* Profile Section */}
            <section className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-none shadow-sm overflow-hidden">
            ...
            <section className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-none shadow-sm overflow-hidden">
                <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center gap-3">
                    ...
                    <h3 className="font-black text-slate-900 dark:text-slate-100 uppercase tracking-widest text-sm">{t('changePassword', { defaultValue: 'Security & Password' })}</h3>
                </div>
