                                    ...
                                    <tr key={product.id} className="group hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors duration-200">
                                            ...
                                            <div className="flex items-center gap-4">
                                                <div className="relative">
                                                    {product.coverImage ? (
                                                        ...
                                                        <div className="w-16 h-16 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 border border-slate-200 dark:border-slate-700 group-hover:scale-105 transition-transform duration-200">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col gap-1.5 w-fit">
                                                <div className="flex items-center gap-1.5 px-2 py-1 rounded-md text-slate-600 dark:text-slate-400 font-medium text-xs">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-1.5 bg-indigo-50 dark:bg-indigo-900/20 px-2 py-1 rounded-md w-fit border border-indigo-100 dark:border-indigo-900/40">
                                                <PackageOpen size={14} className="text-indigo-600 dark:text-indigo-400" />
                                        ...
                                        <td className="px-6 py-4">
                                            <div className={clsx("flex items-center gap-2", isRTL ? "justify-start" : "justify-end")}>
                                                <Menu as="div" className="relative inline-block text-left">
                                                    <MenuButton className="p-2 text-slate-500 hover:text-indigo-600 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-all focus:outline-none">
                                                    ...
                                                    <MenuItems 
                                                        ...
                                                        anchor="bottom end"
                                                        className={clsx(
                                                            "z-50 w-48 mt-1 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 py-2 focus:outline-none",
                                                            "transition duration-100 ease-out [--anchor-gap:4px] sm:[--anchor-gap:8px]",
                                                        ...
                                                        <MenuItem>
                                                            {({ focus }) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <span className="text-slate-700 dark:text-slate-300 font-medium">{t('common:view')}</span>
                                                                </button>
                                                            )}
                                                        </MenuItem>
                                                                ...
                                                                <MenuItem>
                                                                    {({ focus }) => (
                                                                        <button
                                                                            ...
                                                                            className={clsx(
                                                                                "w-full px-4 py-2.5 text-sm flex items-center gap-3 transition-colors text-rose-600 dark:text-rose-400",
                                                                                focus ? "bg-rose-50 dark:bg-rose-900/20" : "",
                                                                                isRTL ? "text-right" : "text-left"
                                                                            )}
                                                                        >
                                                                            <Trash2 size={16} />
